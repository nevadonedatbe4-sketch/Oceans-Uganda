...
const TYPE_OPTIONS = ['All Types', 'Apartment', 'Villa', 'Penthouse', 'Townhouse', 'Family Home', 'Studio', 'Land', 'Commercial'];
...
export default function BuyPage() {
  ...
  // Sync filters → URL params (debounced slightly for typing)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col pt-[88px] md:pt-[96px]">
      <BuySEO count={sourceListings.length} />
      <Navbar />
      ...
      <div className="px-5 md:px-10 pt-8 pb-2">
        <div className="flex items-center gap-2 text-xs font-roboto text-stone-400 mb-3">
          ...
          <span className="text-stone-500">Buy</span>
        </div>
        <h1 className="text-2xl md:text-3xl font-prata text-primary">Properties For Sale</h1>
        <p className="text-sm font-roboto text-stone-500 mt-1">
          Discover exceptional homes across Kampala&apos;s most sought-after neighbourhoods.
        </p>
      </div>
      ...
      <main className="flex-1 px-5 md:px-10 py-7">
        <div className="flex flex-col lg:flex-row gap-7">
          ...
          <div className="flex-1 min-w-0">
            {/* Toolbar with active filter tags */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {filteredAndSorted.length === sourceListings.length && (
                  <span className="text-xs font-roboto text-text-gray">
                    <span className="text-primary font-semibold">{sourceListings.length}</span> listings
                  </span>
                )}
                {/* Active filter pills */}
                {filters.type && (
                ...
                {(filters.type || filters.area || filters.beds || (filters.priceBracket && filters.priceBracket !== 'Any Price') || filters.search.trim()) && (
                  <button
            ...
            <ListingsGrid
              ...
              emptyTitle="No properties for sale match your filters"
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(https://readdy.ai/api/search-image?query=elegant%20Kampala%20Uganda%20residential%20property%20exterior%20lush%20tropical%20garden%20colonial%20architecture%20warm%20golden%20hour%20light%20premium%20real%20estate%20photography&width=1920&height=400&seq=buy-cta1&orientation=landscape)',
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 font-roboto text-sm mb-7 max-w-md mx-auto">
            Our expert agents will assess your property and provide a no-obligation market valuation.
          </p>
          <Link
            to="/landlords"
